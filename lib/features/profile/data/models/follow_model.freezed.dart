...
mixin _$FollowModel {
 ...
 String get id;@JsonKey(name: 'follower_id') String get followerId;@JsonKey(name: 'following_id') String get followingId;@JsonKey(name: 'created_at') DateTime get createdAt;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'follower_id') String followerId,@JsonKey(name: 'following_id') String followingId,@JsonKey(name: 'created_at') DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'follower_id')  String followerId, @JsonKey(name: 'following_id')  String followingId, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FollowModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'follower_id')  String followerId, @JsonKey(name: 'following_id')  String followingId, @JsonKey(name: 'created_at')  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _FollowModel():
return $default(_that.id,_that.followerId,_that.followingId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'follower_id')  String followerId, @JsonKey(name: 'following_id')  String followingId, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _FollowModel() when $default != null:
return $default(_that.id,_that.followerId,_that.followingId,_that.createdAt);case _:
  return null;
...
class _FollowModel extends FollowModel {
  const _FollowModel({required this.id, @JsonKey(name: 'follower_id') required this.followerId, @JsonKey(name: 'following_id') required this.followingId, @JsonKey(name: 'created_at') required this.createdAt}): super._();
